...
public class CaptchaUtil {
    ...
    @Autowired
    private ChineseTextProducer chineseTextProducer;
    @Autowired
	...
	public ModelAndView getImgVc(HttpServletRequest request,
        ...
        if (CaptchaUtil.CAPTCHA_WAY_char.equals(this.captchaWays)) {
        	capValue = capKey = captchaProducer.createText();
        } else if (CaptchaUtil.CAPTCHA_WAY_chinese.equals(this.captchaWays)) {
        	capValue = capKey = chineseTextProducer.getText();
        } else if (CaptchaUtil.CAPTCHA_WAY_calculate.equals(this.captchaWays)) {
